...
class InlineObject18(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'hierarchy': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, hierarchy, version, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            group_ids ([int]): List of group IDs corresponding to which groups should be able to view comment. Defaults to all of requesting user's groups. . [optional]  # noqa: E501
            provenance (str): Identifier (e.g., URL or git hash) that uniquely ties this taxonomy back to an origin or place of record . [optional]  # noqa: E501
            is_latest (bool): Consider this version of the taxonomy with this name the latest? Defaults to True. . [optional]  # noqa: E501
        """
