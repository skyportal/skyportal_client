...
class AssignmentSchema(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, run_id, priority, obj_id, *args, **kwargs):  # noqa: E501
        """AssignmentSchema - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            comment (str): An optional comment describing the request.. [optional]  # noqa: E501
