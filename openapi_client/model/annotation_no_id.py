...
class AnnotationNoID(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, author_id, origin, obj_id, *args, **kwargs):  # noqa: E501
        """AnnotationNoID - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data (bool, date, datetime, dict, float, int, list, str, none_type): Searchable data in JSON format. [optional]  # noqa: E501
        """
