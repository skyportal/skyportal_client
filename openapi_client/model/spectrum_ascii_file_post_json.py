...
class SpectrumAsciiFilePostJSON(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, instrument_id, filename, observed_at, obj_id, ascii, *args, **kwargs):  # noqa: E501
        """SpectrumAsciiFilePostJSON - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            group_ids ([int]): The IDs of the groups to share this spectrum with.. [optional]  # noqa: E501
