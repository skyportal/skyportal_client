...
class PhotMagFlexible(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'limiting_mag': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            ...
            'limiting_mag_nsigma': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'dec_unc': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'magerr': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            ...
            'mag': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'ra': 'ra',  # noqa: E501
        'limiting_mag_nsigma': 'limiting_mag_nsigma',  # noqa: E501
    ...
    def __init__(self, instrument_id, filter, mjd, limiting_mag, obj_id, magsys, *args, **kwargs):  # noqa: E501
        """PhotMagFlexible - a model defined in OpenAPI
        ...
        Args:
            ...
            limiting_mag (bool, date, datetime, dict, float, int, list, str, none_type): Limiting magnitude of the image in the magnitude system `magsys`. Can be given as a scalar or a 1D list. If a scalar, will be broadcast to all values given as lists. Null values not allowed.
        ...
        Keyword Args:
            ...
            limiting_mag_nsigma (bool, date, datetime, dict, float, int, list, str, none_type): Number of standard deviations above the background that the limiting magnitudes correspond to. Null values not allowed. Default = 5.. [optional]  # noqa: E501
