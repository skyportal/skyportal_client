...
class InlineObject22(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'oauth_uid': (str,),  # noqa: E501
            'contact_phone': (str,),  # noqa: E501
            'roles': ([str],),  # noqa: E501
            'group_i_ds_and_admin': ([list],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'group_i_ds_and_admin': 'groupIDsAndAdmin',  # noqa: E501
    }
    ...
    def __init__(self, username, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            oauth_uid (str): [optional]  # noqa: E501
            contact_phone (str): [optional]  # noqa: E501
            roles ([str]): List of user roles. Defaults to `[Full user]`. Will be overridden by `groupIDsAndAdmin` on a per-group basis. . [optional]  # noqa: E501
            group_i_ds_and_admin ([list]): Array of 2-element arrays `[groupID, admin]` where `groupID` is the ID of a group that the new user will be added to and `admin` is a boolean indicating whether they will be an admin in that group, e.g. `[[group_id_1, true], [group_id_2, false]]` . [optional]  # noqa: E501
        """
