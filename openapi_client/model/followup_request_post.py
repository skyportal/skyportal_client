...
class FollowupRequestPost(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'allocation_id': (int,),  # noqa: E501
            'obj_id': (str,),  # noqa: E501
            'target_group_ids': ([int],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'target_group_ids': 'target_group_ids',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, allocation_id, obj_id, *args, **kwargs):  # noqa: E501
        """FollowupRequestPost - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            target_group_ids ([int]): IDs of groups to share the results of the followup request with.. [optional]  # noqa: E501
            payload (bool, date, datetime, dict, float, int, list, str, none_type): Content of the followup request.. [optional]  # noqa: E501
            status (str): The status of the request.. [optional] if omitted the server will use the default value of "pending submission"  # noqa: E501
        """
