...
class PhotometryFlux(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'flux': (float, none_type,),  # noqa: E501
    ...
    def __init__(self, instrument_id, filter, fluxerr, mjd, zp, obj_id, magsys, *args, **kwargs):  # noqa: E501
        """PhotometryFlux - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            flux (float, none_type): Flux of the observation in counts. Can be null to accommodate upper limits from ZTF1, where no flux is measured for non-detections. If flux is null, the flux error is used to derive a limiting magnitude.. [optional]  # noqa: E501
