...
class FacilityTransactionNoID(ModelNormal):
    ...
    attribute_map = {
        ...
        'initiator_id': 'initiator_id',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, followup_request_id, initiator_id, *args, **kwargs):  # noqa: E501
        """FacilityTransactionNoID - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            request (bool, date, datetime, dict, float, int, list, str, none_type): Serialized HTTP request.. [optional]  # noqa: E501
            response (bool, date, datetime, dict, float, int, list, str, none_type): Serialized HTTP response.. [optional]  # noqa: E501
        """
        ...
        self.followup_request_id = followup_request_id
