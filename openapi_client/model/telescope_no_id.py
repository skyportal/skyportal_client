...
class TelescopeNoID(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'elevation': (float, none_type,),  # noqa: E501
            'skycam_link': (str, none_type,),  # noqa: E501
            'robotic': (bool,),  # noqa: E501
            'fixed_location': (bool,),  # noqa: E501
            'weather': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'weather_retrieved_at': (datetime, none_type,),  # noqa: E501
            'weather_link': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'skycam_link': 'skycam_link',  # noqa: E501
        'robotic': 'robotic',  # noqa: E501
        'fixed_location': 'fixed_location',  # noqa: E501
        'weather': 'weather',  # noqa: E501
        'weather_retrieved_at': 'weather_retrieved_at',  # noqa: E501
        'weather_link': 'weather_link',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, nickname, diameter, *args, **kwargs):  # noqa: E501
        """TelescopeNoID - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            lat (float, none_type): Latitude in deg.. [optional]  # noqa: E501
            lon (float, none_type): Longitude in deg.. [optional]  # noqa: E501
            elevation (float, none_type): Elevation in meters.. [optional]  # noqa: E501
            skycam_link (str, none_type): Link to the telescope's sky camera.. [optional]  # noqa: E501
            robotic (bool): Is this telescope robotic?. [optional]  # noqa: E501
            fixed_location (bool): Does this telescope have a fixed location (lon, lat, elev)?. [optional]  # noqa: E501
            weather (bool, date, datetime, dict, float, int, list, str, none_type): Latest weather information. [optional]  # noqa: E501
            weather_retrieved_at (datetime, none_type): When was the weather last retrieved?. [optional]  # noqa: E501
            weather_link (str, none_type): Link to the preferred weather site.. [optional]  # noqa: E501
        """
