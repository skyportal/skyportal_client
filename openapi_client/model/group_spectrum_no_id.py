...
class GroupSpectrumNoID(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_id, spectr_id, *args, **kwargs):  # noqa: E501
        """GroupSpectrumNoID - a model defined in OpenAPI
