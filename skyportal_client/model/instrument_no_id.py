...
class InstrumentNoID(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            ...
            'IMAGING_SPECTROGRAPH': "imaging spectrograph",
        },
        ('api_classname',): {
            'None': None,
            'SEDMAPI': "SEDMAPI",
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
            'telescope_id': (int,),  # noqa: E501
            'band': (str, none_type,),  # noqa: E501
            'filters': ([bool, date, datetime, dict, float, int, list, str, none_type],),  # noqa: E501
            'api_classname': (str, none_type,),  # noqa: E501
            'listener_classname': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        'name': 'name',  # noqa: E501
        'type': 'type',  # noqa: E501
        'telescope_id': 'telescope_id',  # noqa: E501
        'band': 'band',  # noqa: E501
        'filters': 'filters',  # noqa: E501
        'api_classname': 'api_classname',  # noqa: E501
        'listener_classname': 'listener_classname',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type, telescope_id, *args, **kwargs):  # noqa: E501
        """InstrumentNoID - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            band (str, none_type): The spectral band covered by the instrument (e.g., Optical, IR).. [optional]  # noqa: E501
            filters ([bool, date, datetime, dict, float, int, list, str, none_type]): List of filters on the instrument (if any).. [optional]  # noqa: E501
            api_classname (str, none_type): Name of the instrument's API class.. [optional] if omitted the server will use the default value of "SEDMAPI"  # noqa: E501
            listener_classname (str, none_type): Name of the instrument's listener class.. [optional] if omitted the server will use the default value of "SEDMListener"  # noqa: E501
        """
