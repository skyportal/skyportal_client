...
class GroupObjNoID(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'saved_by_id': (int, none_type,),  # noqa: E501
            'saved_at': (datetime,),  # noqa: E501
            'active': (bool, none_type,),  # noqa: E501
            'requested': (bool, none_type,),  # noqa: E501
            'unsaved_by_id': (int, none_type,),  # noqa: E501
            'unsaved_at': (datetime, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'saved_by_id': 'saved_by_id',  # noqa: E501
        'saved_at': 'saved_at',  # noqa: E501
        'active': 'active',  # noqa: E501
        'requested': 'requested',  # noqa: E501
        'unsaved_by_id': 'unsaved_by_id',  # noqa: E501
        'unsaved_at': 'unsaved_at',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_id, obj_id, *args, **kwargs):  # noqa: E501
        """GroupObjNoID - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            saved_by_id (int, none_type): ID of the User that saved the Obj to its Group.. [optional]  # noqa: E501
            saved_at (datetime): ISO UTC time when the Obj was saved to its Group.. [optional]  # noqa: E501
            active (bool, none_type): Whether the Obj is still 'active' as a Source in its Group. If this flag is set to False, the Source will not appear in the Group's sample.. [optional]  # noqa: E501
            requested (bool, none_type): True if the source has been shared with another Group, but not saved by the recipient Group.. [optional]  # noqa: E501
            unsaved_by_id (int, none_type): ID of the User who unsaved the Source.. [optional]  # noqa: E501
            unsaved_at (datetime, none_type): ISO UTC time when the Obj was unsaved from Group.. [optional]  # noqa: E501
        """
