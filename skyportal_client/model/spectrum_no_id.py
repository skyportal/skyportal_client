...
class SpectrumNoID(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, wavelengths, fluxes, obj_id, observed_at, instrument_id, *args, **kwargs):  # noqa: E501
        """SpectrumNoID - a model defined in OpenAPI
