...
class InlineObject2(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, obj_id, origin, data, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            group_ids ([int]): List of group IDs corresponding to which groups should be able to view annotation. Defaults to all of requesting user's groups. . [optional]  # noqa: E501
        """
