...
class FollowupRequestNoID(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, requester_id, obj_id, payload, allocation_id, *args, **kwargs):  # noqa: E501
        """FollowupRequestNoID - a model defined in OpenAPI
