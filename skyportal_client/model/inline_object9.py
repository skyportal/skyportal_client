...
class InlineObject9(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'group_i_ds': ([int],),  # noqa: E501
            'stream_i_ds': ([int],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'group_i_ds': 'groupIDs',  # noqa: E501
        'stream_i_ds': 'streamIDs',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_email, group_i_ds, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            stream_i_ds ([int]): List of IDs of streams invited user will be given access to. If not provided, user will be granted access to all streams associated with the groups specified by `groupIDs`. . [optional]  # noqa: E501
            group_admin ([bool]): List of booleans indicating whether user should be granted admin status for respective specified group(s). . [optional]  # noqa: E501
        """
