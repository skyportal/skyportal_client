...
from skyportal_client import rest
from skyportal_client.configuration import Configuration
from skyportal_client.exceptions import ApiTypeError, ApiValueError, ApiException
from skyportal_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.api_user_user_id_acls_acl_id_delete  # this is an instance of the class Endpoint
        api_instance.api_user_user_id_acls_acl_id_delete()  # this invokes api_instance.api_user_user_id_acls_acl_id_delete.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.api_user_user_id_acls_acl_id_delete.callable or self.callable in this class
