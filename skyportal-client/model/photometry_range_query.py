...
class PhotometryRangeQuery(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'instrument_ids': ([int], none_type,),  # noqa: E501
            'max_date': (datetime, none_type,),  # noqa: E501
            'min_date': (datetime, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        'instrument_ids': 'instrument_ids',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """PhotometryRangeQuery - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            instrument_ids ([int], none_type): IDs of the instruments to query for photometry from. If `None`, queries all instruments.. [optional]  # noqa: E501
            max_date (datetime, none_type): Query for photometry taken before this UT `DateTime`. For an open-ended interval use `None`.. [optional]  # noqa: E501
            min_date (datetime, none_type): Query for photometry taken after this UT `DateTime`. For an open-ended interval use `None`.. [optional]  # noqa: E501
        """
