...
class PhotometryNoID(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, mjd, fluxerr, filter, obj_id, instrument_id, *args, **kwargs):  # noqa: E501
        """PhotometryNoID - a model defined in OpenAPI
