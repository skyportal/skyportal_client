...
class GroupAdmissionRequestNoID(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, group_id, *args, **kwargs):  # noqa: E501
        """GroupAdmissionRequestNoID - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status (str): Admission request status. Can be one of either 'pending', 'accepted', or 'declined'.. [optional]  # noqa: E501
        """
