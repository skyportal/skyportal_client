...
class UserNoID(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'oauth_uid': (str, none_type,),  # noqa: E501
            'preferences': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    def __init__(self, username, *args, **kwargs):  # noqa: E501
        """UserNoID - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            contact_email (str, none_type): The phone number at which the user prefers to receive communications.. [optional]  # noqa: E501
            contact_phone (str, none_type): The email at which the user prefers to receive communications.. [optional]  # noqa: E501
            oauth_uid (str, none_type): The user's OAuth UID.. [optional]  # noqa: E501
            preferences (bool, date, datetime, dict, float, int, list, str, none_type): The user's application settings.. [optional]  # noqa: E501
        """
