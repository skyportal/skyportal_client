...
class StreamInvitationNoID(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, stream_id, invitation_id, *args, **kwargs):  # noqa: E501
        """StreamInvitationNoID - a model defined in OpenAPI
