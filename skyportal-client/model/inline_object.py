...
class InlineObject(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, obj_id, classification, taxonomy_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            probability (float, none_type): User-assigned probability of this classification on this taxonomy. If multiple classifications are given for the same source by the same user, the sum of the classifications ought to equal unity. Only individual probabilities are checked. . [optional]  # noqa: E501
            group_ids ([int]): List of group IDs corresponding to which groups should be able to view classification. Defaults to all of requesting user's groups. . [optional]  # noqa: E501
        """
