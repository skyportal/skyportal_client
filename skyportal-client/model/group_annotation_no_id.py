...
class GroupAnnotationNoID(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_id, annotation_id, *args, **kwargs):  # noqa: E501
        """GroupAnnotationNoID - a model defined in OpenAPI
