...
class StreamNoID(ModelNormal):
    ...
    def __init__(self, name, *args, **kwargs):  # noqa: E501
        """StreamNoID - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            altdata (bool, date, datetime, dict, float, int, list, str, none_type): Misc. metadata stored in JSON format, e.g. `{'collection': 'ZTF_alerts', selector: [1, 2]}`. [optional]  # noqa: E501
        """
