...
class ObservingRun(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'observers': (str, none_type,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, instrument_id, owner_id, calendar_date, *args, **kwargs):  # noqa: E501
        """ObservingRun - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            pi (str, none_type): The name(s) of the PI(s) of this run.. [optional]  # noqa: E501
            observers (str, none_type): The name(s) of the observer(s) on this run.. [optional]  # noqa: E501
            group_id (int, none_type): The ID of the Group associated with this run.. [optional]  # noqa: E501
        """
