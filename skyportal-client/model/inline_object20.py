...
class InlineObject20(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, acl_ids, *args, **kwargs):  # noqa: E501
        """InlineObject20 - a model defined in OpenAPI

        Args:
            acl_ids ([str]): Array of ACL IDs (strings) to be granted to user
