...
class ObservingRunGetWithAssignments(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'calendar_date': (date,),  # noqa: E501
            'group_id': (int,),  # noqa: E501
            'instrument': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'observers': (str,),  # noqa: E501
            'id': (int,),  # noqa: E501
            'ephemeris': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'pi': (str,),  # noqa: E501
            'owner_id': (int,),  # noqa: E501
            'assignments': ([bool, date, datetime, dict, float, int, list, str, none_type],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, instrument_id, calendar_date, *args, **kwargs):  # noqa: E501
        """ObservingRunGetWithAssignments - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            group_id (int): The ID of the group this run is associated with.. [optional]  # noqa: E501
            instrument (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            observers (str): The names of the observers. [optional]  # noqa: E501
            id (int): Unique identifier for the run.. [optional]  # noqa: E501
            ephemeris (bool, date, datetime, dict, float, int, list, str, none_type): Observing run ephemeris data.. [optional]  # noqa: E501
            pi (str): The PI of the observing run.. [optional]  # noqa: E501
            owner_id (int): The User ID of the owner of this run.. [optional]  # noqa: E501
            assignments ([bool, date, datetime, dict, float, int, list, str, none_type]): [optional]  # noqa: E501
        """
