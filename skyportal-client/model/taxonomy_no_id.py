...
class TaxonomyNoID(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'hierarchy': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'version': (str,),  # noqa: E501
            'provenance': (str, none_type,),  # noqa: E501
    ...
    def __init__(self, name, hierarchy, version, *args, **kwargs):  # noqa: E501
        """TaxonomyNoID - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            provenance (str, none_type): Identifier (e.g., URL or git hash) that uniquely ties this taxonomy back to an origin or place of record.. [optional]  # noqa: E501
            is_latest (bool): Consider this the latest version of the taxonomy with this name? Defaults to True.. [optional]  # noqa: E501
        """
