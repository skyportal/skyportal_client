...
class SpectrumPost(ModelNormal):
    ...
    attribute_map = {
        ...
        'wavelengths': 'wavelengths',  # noqa: E501
        ...
        'observed_by': 'observed_by',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, instrument_id, wavelengths, observed_at, fluxes, obj_id, *args, **kwargs):  # noqa: E501
        """SpectrumPost - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            reduced_by ([int]): IDs of the Users who reduced this Spectrum.. [optional] if omitted the server will use the default value of []  # noqa: E501
            errors ([float]): Errors on the fluxes of the spectrum [F_lambda, same units as `fluxes`.]. [optional]  # noqa: E501
            altdata (bool, date, datetime, dict, float, int, list, str, none_type): Miscellaneous alternative metadata.. [optional]  # noqa: E501
            assignment_id (int): ID of the classical assignment that generated this spectrum, if any.. [optional]  # noqa: E501
            origin (str): Origin of the spectrum.. [optional]  # noqa: E501
            group_ids (bool, date, datetime, dict, float, int, list, str, none_type): IDs of the Groups to share this spectrum with. Set to \"all\" to make this spectrum visible to all users.. [optional]  # noqa: E501
            observed_by ([int]): IDs of the Users who observed this Spectrum.. [optional] if omitted the server will use the default value of []  # noqa: E501
            followup_request_id (int): ID of the Followup request that generated this spectrum, if any.. [optional]  # noqa: E501
        """
