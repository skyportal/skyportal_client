...
class AnnotationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __api_annotation_annotation_id_delete(
            self,
            annotation_id,
            **kwargs
        ):
            """api_annotation_annotation_id_delete  # noqa: E501

            Delete an annotation  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_annotation_annotation_id_delete(annotation_id, async_req=True)
            >>> result = thread.get()
        ...
        self.api_annotation_annotation_id_delete = Endpoint(
            settings={
                'response_type': (Success,),
                'auth': [],
                'endpoint_path': '/api/annotation/annotation_id',
                'operation_id': 'api_annotation_annotation_id_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            callable=__api_annotation_annotation_id_delete
        )

        def __api_annotation_annotation_id_get(
            self,
            annotation_id,
            **kwargs
        ):
            """api_annotation_annotation_id_get  # noqa: E501

            Retrieve an annotation  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_annotation_annotation_id_get(annotation_id, async_req=True)
            >>> result = thread.get()
        ...
        self.api_annotation_annotation_id_get = Endpoint(
            settings={
                'response_type': (SingleAnnotation,),
                'auth': [],
                'endpoint_path': '/api/annotation/annotation_id',
                'operation_id': 'api_annotation_annotation_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__api_annotation_annotation_id_get
        )

        def __api_annotation_annotation_id_put(
            self,
            annotation_id,
            **kwargs
        ):
            """api_annotation_annotation_id_put  # noqa: E501

            Update an annotation  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_annotation_annotation_id_put(annotation_id, async_req=True)
            >>> result = thread.get()
        ...
        self.api_annotation_annotation_id_put = Endpoint(
            settings={
                'response_type': (Success,),
                'auth': [],
                'endpoint_path': '/api/annotation/annotation_id',
                'operation_id': 'api_annotation_annotation_id_put',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__api_annotation_annotation_id_put
        )

        def __api_annotation_post(
            self,
            **kwargs
        ):
            """api_annotation_post  # noqa: E501

            Post an annotation  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_annotation_post(async_req=True)
            >>> result = thread.get()
        ...
        self.api_annotation_post = Endpoint(
            settings={
                'response_type': (object,),
                'auth': [],
                'endpoint_path': '/api/annotation',
                'operation_id': 'api_annotation_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__api_annotation_post
        )
