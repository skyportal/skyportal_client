...
class TaxonomiesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __api_taxonomy_get(
            self,
            **kwargs
        ):
            """api_taxonomy_get  # noqa: E501

            Get all the taxonomies  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_taxonomy_get(async_req=True)
            >>> result = thread.get()
        ...
        self.api_taxonomy_get = Endpoint(
            settings={
                'response_type': (ArrayOfTaxonomys,),
                'auth': [],
                'endpoint_path': '/api/taxonomy',
                'operation_id': 'api_taxonomy_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__api_taxonomy_get
        )

        def __api_taxonomy_post(
            self,
            **kwargs
        ):
            """api_taxonomy_post  # noqa: E501

            Post new taxonomy  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_taxonomy_post(async_req=True)
            >>> result = thread.get()
        ...
        self.api_taxonomy_post = Endpoint(
            settings={
                'response_type': (object,),
                'auth': [],
                'endpoint_path': '/api/taxonomy',
                'operation_id': 'api_taxonomy_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__api_taxonomy_post
        )

        def __api_taxonomy_taxonomy_id_delete(
            self,
            taxonomy_id,
            **kwargs
        ):
            """api_taxonomy_taxonomy_id_delete  # noqa: E501

            Delete a taxonomy  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_taxonomy_taxonomy_id_delete(taxonomy_id, async_req=True)
            >>> result = thread.get()
        ...
        self.api_taxonomy_taxonomy_id_delete = Endpoint(
            settings={
                'response_type': (Success,),
                'auth': [],
                'endpoint_path': '/api/taxonomy/taxonomy_id',
                'operation_id': 'api_taxonomy_taxonomy_id_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__api_taxonomy_taxonomy_id_delete
        )

        def __api_taxonomy_taxonomy_id_get(
            self,
            taxonomy_id,
            **kwargs
        ):
            """api_taxonomy_taxonomy_id_get  # noqa: E501

            Retrieve a taxonomy  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_taxonomy_taxonomy_id_get(taxonomy_id, async_req=True)
            >>> result = thread.get()
        ...
        self.api_taxonomy_taxonomy_id_get = Endpoint(
            settings={
                'response_type': (SingleTaxonomy,),
                'auth': [],
                'endpoint_path': '/api/taxonomy/taxonomy_id',
                'operation_id': 'api_taxonomy_taxonomy_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__api_taxonomy_taxonomy_id_get
        )
