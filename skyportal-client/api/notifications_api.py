...
class NotificationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __api_source_notifications_post(
            self,
            **kwargs
        ):
            """api_source_notifications_post  # noqa: E501

            Send out a new source notification  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_source_notifications_post(async_req=True)
            >>> result = thread.get()
        ...
        self.api_source_notifications_post = Endpoint(
            settings={
                'response_type': (object,),
                'auth': [],
                'endpoint_path': '/api/source_notifications',
                'operation_id': 'api_source_notifications_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__api_source_notifications_post
        )
