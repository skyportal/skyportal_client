...
class SystemInfoApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __api_sysinfo_get(
            self,
            **kwargs
        ):
            """api_sysinfo_get  # noqa: E501

            Retrieve system/deployment info  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_sysinfo_get(async_req=True)
            >>> result = thread.get()
        ...
        self.api_sysinfo_get = Endpoint(
            settings={
                'response_type': (object,),
                'auth': [],
                'endpoint_path': '/api/sysinfo',
                'operation_id': 'api_sysinfo_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
