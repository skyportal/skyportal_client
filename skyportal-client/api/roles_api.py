    ...
    def __init__(self, api_client=None):
        ...
        def __api_roles_get(
            ...
            **kwargs
            ...
            Retrieve list of all Role IDs (strings)  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_roles_get(async_req=True)
            >>> result = thread.get()
        ...
        self.api_roles_get = Endpoint(
            settings={
                'response_type': (object,),
                'auth': [],
                'endpoint_path': '/api/roles',
                'operation_id': 'api_roles_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__api_roles_get
        )

        def __api_user_user_id_roles_ignored_args_post(
            self,
            user_id,
            **kwargs
        ):
            """api_user_user_id_roles_ignored_args_post  # noqa: E501

            Grant new Role(s) to a user  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_user_user_id_roles_ignored_args_post(user_id, async_req=True)
            >>> result = thread.get()
        ...
        self.api_user_user_id_roles_ignored_args_post = Endpoint(
            settings={
                'response_type': (Success,),
                'auth': [],
                'endpoint_path': '/api/user/user_id/roles/ignored_args',
                'operation_id': 'api_user_user_id_roles_ignored_args_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__api_user_user_id_roles_ignored_args_post
        )

        def __api_user_user_id_roles_role_id_delete(
            self,
            user_id,
            role_id,
            **kwargs
        ):
            """api_user_user_id_roles_role_id_delete  # noqa: E501

            Delete user role  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_user_user_id_roles_role_id_delete(user_id, role_id, async_req=True)
            >>> result = thread.get()
        ...
        self.api_user_user_id_roles_role_id_delete = Endpoint(
            settings={
                'response_type': (Success,),
                'auth': [],
                'endpoint_path': '/api/user/user_id/roles/role_id',
                'operation_id': 'api_user_user_id_roles_role_id_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__api_user_user_id_roles_role_id_delete
        )
