...
class FacilityApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __api_facility_post(
            self,
            **kwargs
        ):
            """api_facility_post  # noqa: E501

            Post a message from a remote facility  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.api_facility_post(async_req=True)
            >>> result = thread.get()
        ...
        self.api_facility_post = Endpoint(
            settings={
                'response_type': (Success,),
                'auth': [],
                'endpoint_path': '/api/facility',
                'operation_id': 'api_facility_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
