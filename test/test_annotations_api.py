...
class TestAnnotationsApi(unittest.TestCase):
    ...
    def test_api_annotation_annotation_id_delete(self):
        """Test case for api_annotation_annotation_id_delete

        """
        pass

    def test_api_annotation_annotation_id_get(self):
        """Test case for api_annotation_annotation_id_get

        """
        pass

    def test_api_annotation_annotation_id_put(self):
        """Test case for api_annotation_annotation_id_put

        """
        pass

    def test_api_annotation_post(self):
        """Test case for api_annotation_post
