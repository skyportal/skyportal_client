...
from openapi_client.api.candidates_api import CandidatesApi  # noqa: E501
...
class TestCandidatesApi(unittest.TestCase):
    ...
    def test_api_candidates_candidate_id_delete(self):
        """Test case for api_candidates_candidate_id_delete

        """
        pass

    def test_api_candidates_get(self):
        """Test case for api_candidates_get

        """
        pass

    def test_api_candidates_obj_id_get(self):
        """Test case for api_candidates_obj_id_get

        """
        pass

    def test_api_candidates_obj_id_head(self):
        """Test case for api_candidates_obj_id_head

        """
        pass

    def test_api_candidates_post(self):
        """Test case for api_candidates_post
