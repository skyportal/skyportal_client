...
globals()['SpectrumAsciiFileParseJSON'] = SpectrumAsciiFileParseJSON
from openapi_client.model.array_of_spectrum_ascii_file_parse_jso_ns import ArrayOfSpectrumAsciiFileParseJSONs


class TestArrayOfSpectrumAsciiFileParseJSONs(unittest.TestCase):
    """ArrayOfSpectrumAsciiFileParseJSONs unit test stubs"""
    ...
    def testArrayOfSpectrumAsciiFileParseJSONs(self):
        """Test ArrayOfSpectrumAsciiFileParseJSONs"""
        # FIXME: construct object with mandatory attributes with example values
        # model = ArrayOfSpectrumAsciiFileParseJSONs()  # noqa: E501
        pass
