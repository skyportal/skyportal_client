...
class TestInstrumentsApi(unittest.TestCase):
    ...
    def test_api_instrument_get(self):
        """Test case for api_instrument_get

        """
        pass

    def test_api_instrument_instrument_id_delete(self):
        """Test case for api_instrument_instrument_id_delete

        """
        pass

    def test_api_instrument_instrument_id_get(self):
        """Test case for api_instrument_instrument_id_get

        """
        pass

    def test_api_instrument_instrument_id_put(self):
        """Test case for api_instrument_instrument_id_put

        """
        pass

    def test_api_instrument_post(self):
        """Test case for api_instrument_post
