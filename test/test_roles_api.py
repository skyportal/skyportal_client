...
class TestRolesApi(unittest.TestCase):
    ...
    def test_api_user_user_id_roles_ignored_args_post(self):
        """Test case for api_user_user_id_roles_ignored_args_post

        """
        pass

    def test_api_user_user_id_roles_role_id_delete(self):
        """Test case for api_user_user_id_roles_role_id_delete
