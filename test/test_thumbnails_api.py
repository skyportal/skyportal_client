...
class TestThumbnailsApi(unittest.TestCase):
    ...
    def test_api_thumbnail_post(self):
        """Test case for api_thumbnail_post

        """
        pass

    def test_api_thumbnail_thumbnail_id_delete(self):
        """Test case for api_thumbnail_thumbnail_id_delete

        """
        pass

    def test_api_thumbnail_thumbnail_id_get(self):
        """Test case for api_thumbnail_thumbnail_id_get

        """
        pass

    def test_api_thumbnail_thumbnail_id_put(self):
        """Test case for api_thumbnail_thumbnail_id_put
